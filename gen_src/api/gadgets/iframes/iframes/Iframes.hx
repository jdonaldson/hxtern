...
class Iframes{
	...
	public function getHandler(style: String): Dynamic;
	...
	public function open(url: String, openParams: Dynamic, params: Dynamic, ?opt_methods: Dynamic, ?opt_callback: ?Array<Dynamic>->?Array<Dynamic>->?Array<Dynamic>->?Array<Dynamic>->?Array<Dynamic>->?Array<Dynamic>->Dynamic): iframes.Iframe;

	public function propagate(events: Array<String>): Void;

	public function ready(?opt_params: Dynamic, ?opt_methods: Dynamic, ?opt_callback: ?Array<Dynamic>->?Array<Dynamic>->?Array<Dynamic>->?Array<Dynamic>->?Array<Dynamic>->?Array<Dynamic>->Dynamic): Void;
	...
	public function setHandler(style: String, handler: Dynamic): Void;
