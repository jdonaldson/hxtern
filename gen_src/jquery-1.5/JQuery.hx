...
@:native("jQuery")
extern class JQuery{
	public function new(?arg1: Hxtern.Any7<JQuerySelector,js.html.Element,Array<js.html.Element>,Dynamic,JQuery,String,Void->Void>, ?arg2: Hxtern.Any4<js.html.Element,JQuery,Document,Dynamic<Hxtern.Any2<String,jQuery.Event->Void>>>);

	public static function ajax(arg1: Hxtern.Any2<String,Dynamic<Dynamic>>, ?settings: Dynamic<Dynamic>): jQuery.JqXHR {}

	public static function ajaxPrefilter(dataTypes: Hxtern.Any2<String,Dynamic<Dynamic>->Dynamic<Dynamic>->jQuery.JqXHR->Void>, ?handler: Dynamic<Dynamic>->Dynamic<Dynamic>->jQuery.JqXHR->Void): Null<Dynamic> {}
	...
	public static function holdReady(): Bool {}
	...
	public static function map(arr: Array<Dynamic>, _callback: Dynamic->Float->Void): Array<Dynamic> {}
	...
	public function closest(arg1: Hxtern.Any3<JQuerySelector,String,Array<String>>, ?context: js.html.Element): Hxtern.Any2<JQuery,Array<js.html.Element>> {}
	...
	public function find(selector: JQuerySelector): JQuery {}
	...
	public function promise(): jQuery.Promise {}

	public function prop(): Hxtern.Any2<String,JQuery> {}
	...
	public function removeProp(): JQuery {}
	...
	public function trigger(arg1: Hxtern.Any2<String,jQuery.Event>, ?extraParameters: Array<Dynamic>): JQuery {}
	...
	public function undelegate(?selector: String, ?arg2: Hxtern.Any2<String,Dynamic<Dynamic>>, ?handler: Void->Void): JQuery {}
	...
	public function val(?arg1: Hxtern.Any2<String,Float->Dynamic->Void>): Hxtern.Any3<String,Array<String>,JQuery> {}
