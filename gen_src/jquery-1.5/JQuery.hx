...
@:native("jQuery")
extern class JQuery{
	public function new(?arg1: Hxtern.Any7<JQuerySelector,js.html.Element,Array<js.html.Element>,Dynamic,JQuery,String,Void->Void>, ?arg2: Hxtern.Any4<js.html.Element,JQuery,js.html.Document,Dynamic<Hxtern.Any2<String,jQuery.Event->Void>>>);
