...
class WebNavigation{
	public static function getAllFrames(details: Dynamic, _callback: Array<Dynamic<Dynamic>>->Void): Void;

	public static function getFrame(details: Dynamic, _callback: Dynamic<Dynamic>->Void): Void;
