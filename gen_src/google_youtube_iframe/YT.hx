...
extern class Event{
	...
	public var data: hxtern.Any.Any3<String,Float,Null<Dynamic>>;
...
extern class Player{
	public function new(container: hxtern.Any.Any2<String,js.html.Element>, opts: Dynamic<Dynamic>);

	public function addEventListener(eventName: String, listenerName: String): Void {}

	public function clearVideo(): Null<Dynamic> {}

	public function cuePlaylist(playlist: hxtern.Any.Any2<String,Array<String>>, ?index: Float, ?startSeconds: Float, ?suggestedQuality: String): Void {}
	...
	public function getPlaybackQuality(): hxtern.Any.Any2<Null<Dynamic>,String> {}

	public function getPlaybackRate(): Float {}

	public function getPlayerState(): hxtern.Any.Any2<YT.PlayerState,Float> {}
	...
	public function loadPlaylist(playlist: hxtern.Any.Any2<String,Array<String>>, ?index: Float, ?startSeconds: Float, ?suggestedQuality: String): Void {}
