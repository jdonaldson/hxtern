...
class YouTubePlayer{
	...
	public function cuePlaylist(playlistOrObject: String, ?opt_index: Float, ?opt_startSeconds: Float, ?opt_suggestedQuality: String): Void;

	public function cueVideoById(videoIdOrObject: Dynamic, opt_startSeconds: Float): Void;
	...
	public function loadPlaylist(playlistOrObject: String, ?opt_index: Float, ?opt_startSeconds: Float, ?opt_suggestedQuality: String): Void;

	public function loadVideoById(videoIdOrObject: Dynamic, opt_startSeconds: Float): Void;
