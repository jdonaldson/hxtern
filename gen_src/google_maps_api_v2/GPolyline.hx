/**
GPolyline : generated by hxtern
*/
package ;

extern class GPolyline{
	public function new(latlngs: Array<GLatLng>, ?color: String, ?weight: Float, ?opacity: Float, ?opts: Dynamic<Dynamic>);
