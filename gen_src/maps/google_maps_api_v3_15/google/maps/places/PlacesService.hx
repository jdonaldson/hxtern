...
class PlacesService{
	...
	public function radarSearch(request: google.maps.places.RadarSearchRequest, _callback: Array<google.maps.places.PlaceResult>->google.maps.places.PlacesServiceStatus->Void): ;
