...
extern class PlacesService{
	...
	public function radarSearch(request: hxtern.Any.Any2<google.maps.places.RadarSearchRequest,Dynamic<String>>, _callback: Array<google.maps.places.PlaceResult>->google.maps.places.PlacesServiceStatus->Void): Null<Dynamic> {}
