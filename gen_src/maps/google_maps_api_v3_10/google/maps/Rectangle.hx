...
class Rectangle{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.RectangleOptions,Dynamic<String>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.RectangleOptions,Dynamic<String>>): Null<Dynamic>;
