...
class Polygon{
	public function new(?opt_opts: hxtern.Any2<google.maps.PolygonOptions,Dynamic<String>>);
	...
	public function setOptions(options: hxtern.Any2<google.maps.PolygonOptions,Dynamic<String>>): ;
