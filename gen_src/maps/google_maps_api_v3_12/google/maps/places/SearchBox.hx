...
class SearchBox{
	public function new(inputField: HTMLInputElement, ?opt_opts: hxtern.Any.Any2<google.maps.places.SearchBoxOptions,Dynamic<String>>);
	...
	public function getPlaces(): Array<google.maps.places.PlaceResult> {}
