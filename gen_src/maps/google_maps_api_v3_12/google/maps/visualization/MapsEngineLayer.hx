...
extern class MapsEngineLayer{
	public function new(options: hxtern.Any.Any2<google.maps.visualization.MapsEngineLayerOptions,Dynamic<String>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.visualization.MapsEngineLayerOptions,Dynamic<String>>): Null<Dynamic> {}
