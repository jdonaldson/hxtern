...
extern class DrawingManager{
	public function new(?opt_options: hxtern.Any.Any2<google.maps.drawing.DrawingManagerOptions,Dynamic<String>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.drawing.DrawingManagerOptions,Dynamic<String>>): Null<Dynamic> {}
