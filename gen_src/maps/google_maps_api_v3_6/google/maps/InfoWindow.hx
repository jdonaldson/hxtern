...
class InfoWindow{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.InfoWindowOptions,Dynamic<Dynamic>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.InfoWindowOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
