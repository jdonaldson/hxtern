...
extern class Polyline{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.PolylineOptions,Dynamic<Dynamic>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.PolylineOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
