...
class DirectionsRenderer{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.DirectionsRendererOptions,Dynamic<Dynamic>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.DirectionsRendererOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
