...
extern class Marker{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.MarkerOptions,Dynamic<Dynamic>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.MarkerOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
