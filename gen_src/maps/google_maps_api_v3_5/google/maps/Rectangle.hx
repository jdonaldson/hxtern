...
class Rectangle{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.RectangleOptions,Dynamic<Dynamic>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.RectangleOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
