...
extern class PanoramioLayer{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.panoramio.PanoramioLayerOptions,Dynamic<Dynamic>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.panoramio.PanoramioLayerOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
