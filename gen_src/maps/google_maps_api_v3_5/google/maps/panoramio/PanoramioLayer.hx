...
class PanoramioLayer{
	public function new(?opt_opts: google.maps.panoramio.PanoramioLayerOptions);
	...
	public function setOptions(options: google.maps.panoramio.PanoramioLayerOptions): ;
