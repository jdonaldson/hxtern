...
class Spherical{
	public static function computeArea(loop: Array<google.maps.LatLng>, ?opt_radius: Float): Float;
	...
	public static function computeLength(path: Array<google.maps.LatLng>, ?opt_radius: Float): Float;
	...
	public static function computeSignedArea(loop: Array<google.maps.LatLng>, ?opt_radius: Float): Float;
