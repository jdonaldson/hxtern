...
class Circle{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.CircleOptions,Dynamic<String>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.CircleOptions,Dynamic<String>>): Null<Dynamic>;
