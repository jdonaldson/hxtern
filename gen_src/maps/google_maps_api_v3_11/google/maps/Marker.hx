...
extern class Marker extends google.maps.MVCObject {
	...
	public function getIcon(): Hxtern.Any3<String,google.maps.Icon,google.maps.Symbol> {}
	...
	public function getShadow(): Hxtern.Any3<String,google.maps.Icon,google.maps.Symbol> {}
