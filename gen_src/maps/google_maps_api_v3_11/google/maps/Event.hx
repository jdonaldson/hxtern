...
class Event{
	...
	public static function clearInstanceListeners(instance: Dynamic): ;

	public static function clearListeners(instance: Dynamic, eventName: String): ;

	public static function removeListener(listener: google.maps.MapsEventListener): ;

	public static function trigger(instance: Dynamic, eventName: String, ?_opt0: Dynamic, ?_opt1: Dynamic, ?_opt2: Dynamic, ?_opt3: Dynamic, ?_opt4: Dynamic, ?_opt5: Dynamic): ;
}
