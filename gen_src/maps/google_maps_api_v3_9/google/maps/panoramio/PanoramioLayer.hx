...
extern class PanoramioLayer{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.panoramio.PanoramioLayerOptions,Dynamic<String>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.panoramio.PanoramioLayerOptions,Dynamic<String>>): Null<Dynamic> {}
