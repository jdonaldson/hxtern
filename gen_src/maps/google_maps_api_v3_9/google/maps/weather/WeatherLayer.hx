...
extern class WeatherLayer{
	public function new(?opt_opts: hxtern.Any.Any2<google.maps.weather.WeatherLayerOptions,Dynamic<String>>);
	...
	public function setOptions(options: hxtern.Any.Any2<google.maps.weather.WeatherLayerOptions,Dynamic<String>>): Null<Dynamic> {}
