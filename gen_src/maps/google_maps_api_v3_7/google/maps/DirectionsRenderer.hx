...
extern class DirectionsRenderer extends google.maps.MVCObject {
	public function new(?opt_opts: Hxtern.Any2<google.maps.DirectionsRendererOptions,Dynamic<Dynamic>>) {}
	...
	public function setOptions(options: Hxtern.Any2<google.maps.DirectionsRendererOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
