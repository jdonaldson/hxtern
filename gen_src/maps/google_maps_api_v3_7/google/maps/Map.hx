...
class Map{
	...
	public function getMapTypeId(): hxtern.Any2<google.maps.MapTypeId,String>;
	...
	public function setOptions(options: hxtern.Any2<google.maps.MapOptions,Dynamic<Dynamic>>): ;
