...
extern class Rectangle{
	public function new(?opt_opts: Hxtern.Any2<google.maps.RectangleOptions,Dynamic<Dynamic>>);
	...
	public function setOptions(options: Hxtern.Any2<google.maps.RectangleOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
