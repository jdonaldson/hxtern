...
extern class Circle extends google.maps.MVCObject {
	public function new(?opt_opts: Hxtern.Any2<google.maps.CircleOptions,Dynamic<Dynamic>>) {}
	...
	public function setOptions(options: Hxtern.Any2<google.maps.CircleOptions,Dynamic<Dynamic>>): Null<Dynamic> {}
