...
abstract Any7<T1, T2, T3, T4, T5, T6, T7>(Dynamic) from T1 from T2 from T3 from T4 from T5 from T6 to T1 to T2 to T3 to T4 to T5 to T6 to T7{}
abstract Any7<T1, T2, T3, T4, T5, T6, T7, T8>(Dynamic) from T1 from T2 from T3 from T4 from T5 from T6 to T1 to T2 to T3 to T4 to T5 to T6 to T7 to T8{}
